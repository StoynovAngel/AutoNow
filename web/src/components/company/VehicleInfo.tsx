                        ...
                        <div className="p-3 flex flex-col flex-1 min-h-0">
                            ...
                            <div className="space-y-1.5">
                                ...
                                {vehicle.vehicleType === 'RENTAL' && (
                                    <div className="flex items-center justify-between bg-brand-50 border border-brand-200 p-2 rounded-lg">
                                        <div className="flex items-center">
                                            ...
                                            <span className="font-semibold text-xs text-brand-700">PRICE / DAY</span>
                                        </div>
                                        <span className="text-sm font-bold text-brand-700">
                                            {vehicle.rentalPricePerDay != null ? `${vehicle.rentalPricePerDay} EUR` : '—'}
                                        </span>
                                    </div>
                                )}
                                {vehicle.vehicleType === 'RENTAL' && (
                                    <div className="flex items-center justify-between bg-yellow-50 border border-yellow-200 p-2 rounded-lg">
                                        <div className="flex items-center">
                                            <svg className="w-3.5 h-3.5 mr-1.5 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                                            </svg>
                                            <span className="font-semibold text-xs text-yellow-700">DEPOSIT</span>
                                        </div>
                                        <span className="text-sm font-bold text-yellow-700">
                                            {vehicle.securityDepositAmount != null ? `${vehicle.securityDepositAmount} EUR` : '—'}
                                        </span>
                                    </div>
                                )}
