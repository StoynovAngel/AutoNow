...
class UserServiceTest {
	...
	void register_returnToken() {
		...
		when(jwtService.generateToken(any(), eq(TEST_EMAIL), any(), any(), any())).thenReturn(TEST_TOKEN);
	...
	void login_returnToken() {
		...
		when(jwtService.generateToken(any(), eq(TEST_EMAIL), eq(authorities), any(), any())).thenReturn(TEST_TOKEN);
